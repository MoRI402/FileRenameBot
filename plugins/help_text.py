    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/AnimaxChatZone'),
                    InlineKeyboardButton('Feedback', url='https://t.me/AnimaxChatZone')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/weetaku_anime'),
                    InlineKeyboardButton('Anime Channel', url='https://t.me/Animax_Industry')
                ]
            ]
        ),
